...
<section
    class="relative max-w-5xl w-full h-full md:h-48 lg:h-56 xl:h-60 bg-slate-800 bg-opacity-50 backdrop-blur-[2px] shadow-md shadow-slate-800 rounded-lg overflow-hidden"
>
    <div
